...
export function useRegisterForm() {
  ...
  const form = ref<RegisterUser>({
    ...
    email: '',
    password: '',
    is_professional: false,  // Nuevo campo para indicar si es profesional
    specialty: '',           // Campos adicionales para profesionales
    image: '',
    description: '',
  });
  ...
  async function handleRegister() {
    ...
    try {
      ...
      // Restablecer formulario tras registro exitoso
      form.value = {
        name: '',
        email: '',
        password: '',
