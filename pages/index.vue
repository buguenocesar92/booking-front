  ...
  <div class="bg-gray-50 dark:bg-gray-900 min-h-screen">
    ...
    <div class="relative bg-gradient-to-r from-indigo-600 to-purple-600 py-12 z-10">
      <div class="container mx-auto px-4 relative z-20">
        <h1 class="text-4xl font-bold text-white text-center mb-4 mt-10">Reserva tu Cita Profesional</h1>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 max-w-4xl mx-auto flex flex-col md:flex-row gap-4 relative z-30">
          ...
          <div class="md:w-1/4">
            <select class="w-full py-2 px-4 rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
          ...
          >
            <div class="relative">
              <NuxtLink :to="`/professionales/${pro.id}`">
                ...
                <div class="absolute top-3 right-3 bg-white dark:bg-gray-800 rounded-full px-2 py-1 text-xs font-medium text-indigo-600 dark:text-indigo-400 shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <div class="p-5">
              <div class="flex justify-between items-start mb-2">
                <NuxtLink :to="`/professionales/${pro.id}`">
                  <h3 class="text-xl font-bold text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                    {{ pro.name }}
                  </h3>
                </NuxtLink>
                ...
                <div class="flex items-center">
                  ...
                  <span class="ml-1 text-sm font-medium text-gray-700 dark:text-gray-300">{{ getRandomRating() }}</span>
                </div>
              </div>
              ...
              <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex space-x-2">
                  <button class="p-2 rounded-full bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-600 dark:text-gray-300 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const { data: professionals, pending, error } = await useAsyncData<Professional[]>('professionals', async () => {
  try {
...
// Añadir esta función en el script setup
function handleSearch() {
  // Implementar la lógica de búsqueda aquí
  console.log('Búsqueda iniciada');
  // Aquí podrías filtrar los profesionales o hacer una nueva petición
}

// Helper functions para generar datos aleatorios para la demo
